...
MultiClassMod::MultiClassMod() :
    ConfigEnabled(false),
    ConfigDisplayInstructionMessage(false),
    ConfigCrossClassIncludeSkillIDs(),
    ConfigUsingTransmogMod(false),
    ConfigEnableMasterSkills(false),
    ConfigLevelsPerToken(10),
    ConfigBonusTokenLevels()
{
